...
```{r}
# Below is the more descriptive statistics
library(pastecs)
stat.desc(Salaries,norm = TRUE)
```
...
pairs(Salaries_clean[, c("experience_level", "work_year", "remote_ratio", "salary_in_usd")])
# View below will help us visualize the relationship for several pairs of variables
```
